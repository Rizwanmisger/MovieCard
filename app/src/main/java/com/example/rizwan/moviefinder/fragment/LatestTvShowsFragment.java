...
public class LatestTvShowsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view_now_playing_tv);
        ...
        Call<TvShowResponse> call = apiService.getNowPlayingTV(API_KEY);
